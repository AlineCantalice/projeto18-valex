...
function find() {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield postgres_1.connection.query("SELECT * FROM cards");
        return result.rows;
    });
}
exports.find = find;
function findById(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield postgres_1.connection.query("SELECT * FROM cards WHERE id=$1", [id]);
...
function findByTypeAndEmployeeId(type, employeeId) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield postgres_1.connection.query(`SELECT * FROM cards WHERE type=$1 AND "employeeId"=$2`, [type, employeeId]);
        return result.rows[0];
    });
}
...
function findByCardDetails(number, cardholderName, expirationDate) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield postgres_1.connection.query(` SELECT 
        * 
      FROM cards 
...
function remove(id) {
    return __awaiter(this, void 0, void 0, function* () {
        postgres_1.connection.query("DELETE FROM cards WHERE id=$1", [id]);
    });
}
